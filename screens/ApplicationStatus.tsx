  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col bg-[#122017] overflow-hidden">
      ...
      <div className="flex items-center p-4 pb-2 justify-between z-10">
        ...
        <h2 className="text-white text-lg font-bold leading-tight tracking-tight flex-1 text-center pr-12">Application Status</h2>
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-4 pb-12 z-10">
        ...
        <div className="my-6">
          <div className="w-full bg-center bg-no-repeat bg-cover flex flex-col justify-center items-center overflow-hidden bg-primary/10 rounded-3xl min-h-64 relative border border-primary/20 shadow-2xl shadow-black/40" 
            ...
            <div className="bg-primary/20 p-6 rounded-full backdrop-blur-md border border-primary/30 animate-pulse">
              <span className="material-symbols-rounded text-primary text-6xl">schedule</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-wrap gap-4 p-4">
          <div className="flex min-w-[158px] flex-1 flex-col gap-2 rounded-3xl p-6 bg-[#0B150F] border border-primary/20 shadow-lg shadow-primary/5">
            <div className="flex items-center justify-between">
              ...
              <span className="material-symbols-rounded text-primary text-xl">pending_actions</span>
            </div>
            <p className="text-white tracking-tight text-2xl font-bold leading-tight mt-1">Pending Approval</p>
            <div className="flex items-center gap-2 mt-2">
              <div className="w-2 h-2 rounded-full bg-primary animate-pulse"></div>
              <p className="text-primary text-sm font-semibold leading-normal">Processing Application</p>
            </div>
          </div>
        </div>
        ...
        <div className="px-6 py-4 flex flex-col gap-6">
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              <p className="text-primary font-semibold text-sm">Admin Verification</p>
              <p className="text-gray-500 text-xs">Expected within 24 hours</p>
            </div>
          </div>
        </div>
      </div>
